...
func Update() {
	...
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/ilius/qt/cmd/..."), "run \"go clean cmd\"")
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/ilius/qt/internal/..."), "run \"go clean internal\"")
	...
	utils.RunCmd(exec.Command("go", "install", "-v", fmt.Sprintf("-ldflags=\"-X=github.com/ilius/qt/internal/cmd.buildVersion=%v\"", hash), fmt.Sprintf("github.com/ilius/qt/cmd/...")), "run \"go install\"")
...
func Upgrade() {
	...
	utils.RunCmd(exec.Command("go", "clean", "-i", "github.com/ilius/qt/..."), "run \"go clean\"")
	utils.RemoveAll(utils.GoQtPkgPath())

	utils.RunCmd(exec.Command("go", "get", "-v", "-d", "github.com/ilius/qt/cmd/..."), "run \"go get\"")
