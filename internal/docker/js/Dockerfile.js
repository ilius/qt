...
RUN /usr/local/go/bin/go get -tags=no_env github.com/ilius/qt/cmd/...
...
COPY --from=base $GOPATH/src/github.com/ilius/qt $GOPATH/src/github.com/ilius/qt
...
RUN cd $GOPATH/src/github.com/ilius/qt/internal/examples/widgets/line_edits && $GOPATH/bin/qtdeploy build js && rm -rf ./deploy
